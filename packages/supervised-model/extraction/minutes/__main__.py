    ...
    with open(json_file_path, "r") as f:
        ...
        for _, message in messages.items():
            ...
            for parsed in parsed_motions:
                df = dict_to_df(parsed, os.path.basename(json_file_path))  # Pass only the filename
                dfs.append(df)
...
if __name__ == "__main__":
    ...
    final_df = final_df.drop(columns=["movedBy", "proposedBy", "action", "annotation", "secondedBy", "council_member", "vote"])
