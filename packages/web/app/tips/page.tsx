...
const TipsPage: React.FC = () => {
  return (
    <div className="min-h-[85vh] bg-blue px-6 text-primary md:flex">
      <div className="md:grow"></div>
      <div className="pb-24 md:w-3/4 md:max-w-2xl">
        <section className="space-y-4">
          <h2 className="text-xl font-bold">
            I’m not quite sure how to use this app. What kinds of questions can
            I ask?
          </h2>
          <p>
            Think about the kinds of topics that are covered during City Council
            meetings, and the different people who speak. This includes
            councilmembers, mayoral staff, public agency representatives,
            activists, and other civic actors. Instead of watching many hours of
            City Council recordings to find out what has been said about a
            topic, use this app to do that search for you in fewer than 60
            seconds!
          </p>
          ...
          <ul className="m-2 list-inside list-disc">
            ...
            <li>
              For example, you could ask: “What data does NOPD have to show the
              effectiveness of crime cameras in New Orleans?”
            </li>
            <li>
          ...
          <p>
            The app is in development – feel free to use it for asking different
            kinds of questions, and this will help EOS improve the app and make
            it more useful.
          </p>
        </section>
      </div>
