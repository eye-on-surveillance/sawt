...
const AboutPage: React.FC = () => {
  return (
    <div className={styles["about-content"]}>
      <div className="px-6 text-secondary md:flex">
        ...
        <div className="pb-24 md:w-3/4 md:max-w-2xl">
          <section className="space-y-4">
            ...
            <p>
              ...
              what is being shared and discussed in City Council meetings. The
              app uses advanced language modeling, a form of artificial
              intelligence, to:
            </p>
            ...
            <p>
              ...
              the original source materials not uncovered by Sawt. There may
              also be inaccuracies in what is stated or presented during a City
              Council meeting – Sawt is not a fact checker.
            </p>
            <p>
              ...
              research, and advocacy purposes. Here are some follow-up steps
              that you could take:
            </p>
            <ul className="m-2 list-inside list-disc">
              ...
              <li>
                Watch the City Council meeting recording to understand the
                context within which something was said.
              </li>
              <li>
                Follow up with the speaker and/or file a public records request
                to find official records and documentation in regards to a
                particular topic.
              </li>
              <li>
                Verify and contextualize Sawt results with other sources of
                data, such as news reports, civic organization and monitor
