...
--
-- Name: user_queries user_queries_id_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY "public"."user_queries"
    ADD CONSTRAINT "user_queries_id_key" UNIQUE ("id");
...
--
-- Name: user_queries insert: everyone; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "insert: everyone" ON "public"."user_queries" FOR INSERT WITH CHECK (true);


--
-- Name: user_queries select: everyone; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "select: everyone" ON "public"."user_queries" FOR SELECT USING (true);


--
-- Name: user_queries update: everyone; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "update: everyone" ON "public"."user_queries" FOR UPDATE USING (true) WITH CHECK (true);
